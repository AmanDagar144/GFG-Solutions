<h2><a href="https://www.geeksforgeeks.org/problems/series-ap5310/1">Series AP</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="user-select: auto;"><p style="user-select: auto;"><span style="font-size: 18px; user-select: auto;">Given the first 2 terms a1 and a2 of an Arithmetic Series.Find the n<sup style="user-select: auto;">th</sup> term of the series.&nbsp;</span></p>
